#ifndef INKWELL_TEST_DATA_FIXTURE_H
#define INKWELL_TEST_DATA_FIXTURE_H
 ...
 *
 * The path is resolved against INKWELL_TEST_DATA_DIR, which tests/CMakeLists.txt defines as the
...
char *inkwell_test_data_read(const char *name, size_t *len);

#endif /* INKWELL_TEST_DATA_FIXTURE_H */
