...
bool https_fixture_start(struct https_fixture *fixture, https_fixture_handler handler,
    ...
    fixture->child = -1;
    fixture->listen_fd = -1;
    snprintf(fixture->ca_path, sizeof fixture->ca_path, "/tmp/inkwell-https-%d.pem", (int)getpid());
    snprintf(fixture->log_path, sizeof fixture->log_path, "/tmp/inkwell-https-%d.log",
             (int)getpid());
